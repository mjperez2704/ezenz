  ...
  return (
    <section className="py-12 px-4">
      <div className="max-w-lg mx-auto">
        <h2 className="text-3xl font-bold text-white text-center mb-8">Nuestros Productos</h2>

        <div className="relative bg-gradient-to-br from-gray-900/20 to-gray-800/20 rounded-2xl p-6 border border-white/10">
          ...
          <div className="space-y-3 text-center">
            ...
            <p className="text-sm text-gray-300">{currentProduct.action}</p>
            ...
            <Button asChild className="w-full bg-black hover:bg-gray-800">
              <Link href={`/mobile/productos/${currentProduct.id}`}>Ver Detalles</Link>
            </Button>
          </div>

          <div className="flex justify-between items-center mt-6">
            <Button variant="ghost" size="icon" onClick={prevProduct} className="text-white">
            ...
            <Button variant="ghost" size="icon" onClick={nextProduct} className="text-white">
